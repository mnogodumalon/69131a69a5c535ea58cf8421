...
const APP_TITLE = 'Lagerverwaltung';
const APP_SUBTITLE = 'Bestellungen & Lager';

const navigation = [
  { name: 'Übersicht', href: '/', icon: LayoutDashboard },
  { name: 'Lieferanten', href: '/lieferanten', icon: FileText },
  { name: 'Bestellungen', href: '/bestellungen', icon: ShoppingCart },
  { name: 'Produkte', href: '/produkte', icon: Package },
  { name: 'Lagerbestand', href: '/lagerbestand', icon: Boxes },
  { name: 'Wareneingang', href: '/wareneingang', icon: FileText },
];
