        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>Einkaufspreis (EUR)</TableHead>
              <TableHead>Verkaufspreis (EUR)</TableHead>
              <TableHead>Mindestbestand</TableHead>
              <TableHead>Einheit</TableHead>
              <TableHead>Barcode</TableHead>
              <TableHead>Bild-URL</TableHead>
              <TableHead>Produktstatus</TableHead>
          ...
          <TableBody>
            {filtered.map(record => (
              <TableRow key={record.record_id} className="hover:bg-muted/50 transition-colors">
                <TableCell className="font-medium">{record.fields.produktname ?? '—'}</TableCell>
                ...
                <TableCell>{record.fields.einkaufspreis ?? '—'}</TableCell>
                <TableCell>{record.fields.verkaufspreis ?? '—'}</TableCell>
                <TableCell>{record.fields.mindestbestand ?? '—'}</TableCell>
                <TableCell><Badge variant="secondary">{record.fields.einheit ?? '—'}</Badge></TableCell>
                <TableCell>{record.fields.barcode ?? '—'}</TableCell>
                <TableCell>{record.fields.bild_url ?? '—'}</TableCell>
                <TableCell><Badge variant="secondary">{record.fields.aktiv ?? '—'}</Badge></TableCell>
                <TableCell>
